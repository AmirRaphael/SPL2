...
public class Tester {
    ...
    */
    ...
    public void runTestsFromFile() {
        ...
        try {
            currentTests = getTestsFromJson("/Users/amirzaushnizer/Desktop/SPL2/src/main/java/bgu/spl/mics/Tests.json");
    ...
    */
    ...
    public void runLogicalTests() {
        try {
            ...
            hanSoloObj = new HanSoloMicroservice(new CountDownLatch(5),new CountDownLatch(5));
            C3POObj = new C3POMicroservice(new CountDownLatch(5),new CountDownLatch(5));

            MessageBusImpl messageInstance = (MessageBusImpl) MessageBusImpl.getInstance();
